        ...
        <CFlex w="40vw" justify="center" direction="column">
          ...
          <CFlex mb="3" justify="center" direction="row" align="center">
            <CInputGroup size="md" w="100%">
              <CInput
                type="text"
                placeholder="Reveal the obscurity..."
              ...
              <CInputRightElement width="4.5rem">
                <CCloseButton
                  h="1.75rem"
                  size="sm"
                  @click="() => (this.articleFilters.search = '')"
                />
              </CInputRightElement>
            </CInputGroup>
            <CButton variant-color="green" ml="3" @click="showArticles"
              >Search</CButton
            >
          </CFlex>
          <CButton
          ...
          <CCollapse :is-open="showCollapse">
            ...
            <CFormControl mb="3">
              ...
              <CFlex align="center">
                ...
                <CButton
                  ...
                  ml="2"
                  px="40px"
                  @click="orderDate = orderDate === 'asc' ? 'desc' : 'asc'"
                  >Sort by
                  {{ orderDate === 'asc' ? 'Oldest' : 'Newest' }}</CButton
                >
              </CFlex>
            </CFormControl>
            <CStack
            ...
            >
              <CTag
                v-for="(tag, index) in articleFilters.tags"
                :key="tag"
                variant="solid"
